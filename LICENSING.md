...
A `LICENSE-pocketbase` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [pocketbase/pocketbase](https://github.com/pocketbase/pocketbase), Copyright
2022 - present, Gani Georgiev, licensed under MIT. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../pocketbase-port/specs/SPEC-001-pocketbase.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
